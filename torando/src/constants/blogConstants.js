...
export const BLOG_UPDATE_RESET = "BLOG_CREATE_RESET";

export const BLOG_NEWEST_REQUEST = "BLOG_NEWEST_REQUEST";
export const BLOG_NEWEST_SUCCESS = "BLOG_NEWEST_SUCCESS";
export const BLOG_NEWEST_FAIL = "BLOG_NEWEST_FAIL";
